    ...
    return <div>
        ...
        <div>
          ...
          <div className="mt-4 ml-20 h-[100px]">
              <NgoLowerCard title={"Greenpeace"} body={"Greenpeace is a global environmental organization advocating for climate action, ocean conservation, and protection of natural habitats. They use peaceful protests and campaigns to promote sustainable solutions and environmental justice."} pastTransaction={""}/>
          </div>
        </div>
        <div>
